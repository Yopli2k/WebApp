...
class WidgetSelect extends BaseWidget
{
    ...
    {
        if (false === isset(static::$codeModel)) {
        ...
        foreach ($data['children'] as $child) {
            ...
            $this->setValuesFromArray($data['children'], !$this->required, 'text');
            break;
        }
    }
     ...
     * @param string $col2
     */
    public function setValuesFromArray(array $items, bool $addEmpty = false, string $col1 = 'value', string $col2 = 'title'): void
    {
    ...
    public function setValuesFromArrayKeys(array $values, bool $addEmpty = false): void
    {
        $this->values = $addEmpty ? [['value' => null, 'title' => '------']] : [];
     ...
     * @param array $rows
     */
    public function setValuesFromCodeModel(array $rows): void
    {
        $this->values = [];
